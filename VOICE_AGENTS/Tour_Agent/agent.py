...
5. CRITICAL: Do NOT use any markdown formatting (no #, ##, ###, headings, bold, italic, etc.)
6. CRITICAL: Do NOT include any links, URLs, or hyperlinks in your response
7. CRITICAL: Do NOT cite sources or add references like [source] or (source)
8. CRITICAL: Write in plain text only, as if speaking naturally to someone
9. CRITICAL: Use single spaces between sentences, avoid multiple consecutive newlines
10. Make sure the details are conversational and don't include any formatting or headings. It will be directly used in an audio model for converting to speech and the entire content should feel like natural speech.
11. Make sure the content is strictly between the upper and lower Word Limit as specified. For example, If the word limit is 100 to 120, it should be within that, not less than 100 or greater than 120

NOTE: Given a location, use web search to retrieve up‑to‑date context and architectural information about the location, but do NOT include the source in your output

Help users see and appreciate architectural details they might otherwise miss. Make it as detailed and elaborative as possible. Output ONLY plain text narrative, nothing else.
""")
...
NOTE: Given a location, use web search to retrieve up‑to‑date context and culinary information about the location, but do NOT include the source in your output

Make your descriptions vivid and appetizing. Include practical information like operating hours when relevant. Make it as detailed and elaborative as possible. Output ONLY plain text narrative, nothing else.
""")
...
NOTE: Given a location, use web search to retrieve up‑to‑date context and all the cultural information about the location, but do NOT include the source in your output

Focus on authentic cultural insights that help users appreciate local ways of life. Make it as detailed and elaborative as possible. Output ONLY plain text narrative, nothing else.
""")
...
NOTE: Given a location, use web search to retrieve up‑to‑date context and historical information about the location, but do NOT include the source in your output

Focus on making history come alive through engaging narratives. Keep descriptions concise but informative. Make it as detailed and elaborative as possible. Output ONLY plain text narrative, nothing else.
""")
