...
def main():
    ...
    if DEEPSEEK_API_KEY:
        try:
            ...
            st.error(f"❌ Error initializing DeepSeek model: {e}")
            return
            ...
            with st.spinner("Creating your perfect health and fitness routine..."):
                try:
                    dietary_agent = Agent(
                        ...
                        instructions="""You are a dietary expert providing personalized dietary recommendations.
                    ...
                    fitness_agent = Agent(
                        name="Fitness Expert",
                        model=deepseek_model,
                        instructions="""You are a fitness expert providing personalized fitness recommendations.
            ...
            if st.button("Get Answer"):
                if question_input:
                    with st.spinner("Finding the best answer for you..."):
                        ...
                        try:
                            agent = Agent(model=deepseek_model, debug_mode=True, markdown=True)
